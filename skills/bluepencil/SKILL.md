...
Repetition can be load-bearing. A deliberate bookend (thesis at the open,
returned to at the close), a topic sentence and its elaboration, a recurring
theme name, a plain-language gloss calibrating a technical claim for a mixed
audience — these do work the reader needs. Test: cut the second instance —
does the reader lose orientation, emphasis, or audience access? If yes, keep
it; flag only the echo that adds nothing.
